...
import { Button, Card, Container, Flex, Grid, Group, Loader, Tabs, Text, Title } from '@mantine/core'
  ...
  return (
    <Tabs defaultValue='sellscale'>
      <Tabs.List>
        ...
        <Tabs.Tab value='smartlead'>Email Beta {numberLeads > 0 && ' - ' + numberLeads}</Tabs.Tab>
      </Tabs.List>
