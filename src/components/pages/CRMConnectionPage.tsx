        ...
        <Card ml='md'>
            ...
            <Paper withBorder m="xs" p="lg" radius="md" bg={"#fcfcfd"}>
                    ...
                    <Flex align={"center"} gap={"sm"}>
                        ...
                        <Box>
                            <Text fw={600}>
                                {
                                    integration ? 
                                        (<span>{integration.integration} CRM <span style={{fontWeight: 400}}>connected to</span> {integration?.end_user_organization_name}</span>): 'Connect to your CRM to SellScale'
                                }
                                
                            </Text>
                            <Text color='gray' size='sm'>Connected by: {integration?.end_user_email_address}</Text>
                        </Box>
                        <Button
                            ml='lg'
                ...
                <Text color="gray" size={"xs"} mt={"md"}>
                    Add SellScale to your CRM via integration to automatically transfer contact, lead, and account information between
                    SellScale and your CRM. This is the recommended option as it allows you
                    to get real time alerts and visibility into company and people activities.
                </Text>
            </Paper>

            {
                integration && (
                    <Paper withBorder m="xs" p="lg" radius="md" bg={"#fcfcfd"}>
                        <Text size='22px' fw='500'>CRM Connection Settings</Text>
                        <Divider mt='md' />
