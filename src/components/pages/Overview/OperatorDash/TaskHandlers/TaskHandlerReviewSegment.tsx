...
export const TaskHandlerReviewSegment = (props: TaskHandlerReviewSegment) => {
    ...
    return (
        <>
        <iframe 
            src={'https://sellscale.retool.com/embedded/public/9aea3067-84d7-4afa-9aa8-3eda4450d04b#authToken=' + userToken + "&segmentId=" + props.data['segment_id'] + "&taskId=" + props.taskId}
            width={'100%'}
