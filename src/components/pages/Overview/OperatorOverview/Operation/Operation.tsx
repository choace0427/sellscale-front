import { ActionIcon, Box, Collapse, Divider, Flex, ThemeIcon, rem } from '@mantine/core';
import { useDisclosure } from '@mantine/hooks';
import { IconCalendar, IconCheck, IconChevronDown, IconClock, IconMessage, IconTargetArrow } from '@tabler/icons';
...
const Operation: FC<Props> = ({
  ...
  return (
    ...
    >
      <Flex align={'center'} justify={'space-between'} role='button' sx={{ cursor: 'pointer' }}>
