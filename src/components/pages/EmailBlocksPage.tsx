...
export default function EmailBlocksPage() {
              ...
              activeArchetype.length == 0 ? (
                ...
                <Flex w='100%'>
                  <Flex w='40%' direction='column' pr='8px'>
                    ...
                    <Text mt='md'>Email blocks will influence how your emails are structured when generated by SellScale AI</Text>
                    <Text mt='sm'>Take your time to create the best email blocks for your persona.</Text>
                    <Text mt='sm'>Generation preview coming soon!</Text>
                  </Flex>
                  <Flex w='60%'>
                    <EmailBlocksDND
                      archetypeId={activeArchetype[0]}
                    />
                  </Flex>
                </Flex>
              )
