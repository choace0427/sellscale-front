...
import { Card, Container, Flex, Tabs, Title, Text, Button, Badge, Tooltip, TextInput, LoadingOverlay } from "@mantine/core";
                  ...
                  <Flex direction='column' maw='500px'>
                    ...
                    <Flex align='center'>
                      ...
                      <Tooltip
                        withArrow
                        withinPortal
                        label={ currentProject.active ? "Your persona is active and is creating and sending messages." : "Your persona is inactive and is not creating or sending messages."}
                      >
                        <Badge
                          size='sm'
                          variant="filled"
                  ...
                  <Flex justify='space-between' align='center'>
                    <Flex direction='column' maw='500px'>
                      ...
                      <Text fw='light' fz='sm' lh='1.2rem' mt='2px'>
                        Deactivating your persona will stop any further campaigns and messages. You can reactivate at any time.
                      </Text>
                    </Flex>
                    <Flex>
                      <Button
                        ...
                        onClick={() => {
                          openConfirmModal({
                            title: <Title order={3}>Deactivate Persona - {currentProject.name}</Title>,
                            children: (
                              <>
                                <Text fs='italic'>
                                ...
                                <Text mt='md'>
                                  <b>Basic Deactivate:</b> Deactivating this persona will prevent any new message generation, but Prospects still in the pipeline will continue to receive messages.
                                </Text>
                                <Text mt='xs'>
                                  <b>Hard Deactivate:</b> Hard deactivating this persona will wipe all messages from the pipeline and stop any and all contact with Prospects. Hard deactivating may take a few minutes.
                                </Text>
                                {/* <TextInput
                            ...
                            labels: { confirm: 'Basic Deactivate', cancel: 'Hard Deactivate' },
                            cancelProps: { color: 'red', variant: 'outline' },
                            confirmProps: { color: 'red' },
                            onCancel: () => { triggerHardPersonaDeactivation() },
                            onConfirm: () => { triggerBasicPersonaDeactivation() },
                          })
                        }}
                      >
                        Deactivate
