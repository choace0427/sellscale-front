import { Avatar, Badge, Box, Checkbox, Divider, Flex, Text, Timeline, Title, useMantineTheme } from '@mantine/core';
      ...
      <Box bg={'white'} p={'lg'}>
        <Flex gap={'md'} mb={'sm'} align={'center'}>
          ...
          <Divider
            ...
            w={'100%'}
            label={
              <Flex gap={'sm'} align={'center'} style={{ border: '1px solid #ced4da', borderRadius: '24px' }} px={40} py={'xs'}>
                <Text>Show:</Text>
          ...
          return (
            <div key={index}>
              ...
              <Flex direction={'column'} justify={'center'}>
                      ...
                      <Timeline.Item
                        ...
                        title={
                          <Flex gap={'sm'} align={'center'} pt={5}>
                            <div>
                              <Badge variant='outline' size='lg' color={valueToColor(theme, subitem.noti_title)}>
                                {subitem.noti_title}
                              </Badge>
                            </div>
                            <Flex gap={'3px'} align={'center'}>
                              <Text className='w-max' fw={500}>
                                {subitem?.noti_username ? subitem?.noti_sub + ':' : subitem?.noti_sub}
                              </Text>
                ...
                {data.length !== index + 1 && <Divider orientation='vertical' h={'40px'} mt={'-md'} w={'1px'} ml={'20px'} variant='dashed' />}
              </Flex>
            </div>
          );
        })}
