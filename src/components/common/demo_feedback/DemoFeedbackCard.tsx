      ...
      <Flex justify="space-between">
        <Flex direction="row">
          ...
          <Flex direction="column">
            <Text fw={700} fz="sm">
              Demo {props.index && `#${props.index}`} with{" "}
              {props.prospect.full_name}
            </Text>
            <Text fz="sm" c="dimmed">
              {new Date(props.demoFeedback.demo_date).toLocaleString("en-US", {
                month: "long",
                day: "numeric",
                year: "numeric",
              })}
        ...
        <Flex>
          <ActionIcon
            size="xs"
            variant="transparent"
            onClick={openEditDemoFeedbackModal}
          >
            <IconEdit size={"1rem"} />
          </ActionIcon>
      ...
      {props.demoFeedback && (
        <>
          ...
          <Box>
            ...
            <Text fz="sm">{props.demoFeedback.feedback}</Text>
          </Box>
          {props.demoFeedback.next_demo_date && (
            <Box mt="sm">
              ...
              <Text fz="sm">
                {new Date(props.demoFeedback.next_demo_date).toLocaleString(
                  "en-US",
