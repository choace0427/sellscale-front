      ...
      >
        <Flex align={'center'} gap={10}>
          ...
          <Flex align={'center'} gap={10}>
            ...
            {currentProject?.linkedin_active ? <IconBrandLinkedin color='white' fill='#228be8' /> : <></>}
            {currentProject?.email_active ? <IconMail color='white' fill='#228be8' /> : <></>}
          </Flex>
          <Divider orientation='vertical' h={'60%'} m={'auto'} />
          <Tooltip
              ...
              <Button
                ...
                onClick={() => {
                  openConfirmModal({
                    ...
                    children: (
                      <Text>
                        Are you sure you want to remove these {Object.keys(selectedRows).length} prospects? This will
