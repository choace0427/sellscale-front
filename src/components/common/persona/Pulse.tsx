import { Paper, Title, Text, Textarea, Button, LoadingOverlay, Flex, Card, Tabs, Select, Group, Badge, useMantineTheme } from "@mantine/core";
...
export default function Pulse(props: {
  ...
  const openRunAllModal = () => openConfirmModal({
        ...
        <Flex w='40%'>
          <Paper withBorder p="xs" w="100%">
            ...
            <Tabs defaultValue="test" color='teal'>
              <Tabs.List>
                <Tabs.Tab value="test" icon={<IconTestPipe size="0.8rem" />}>Test</Tabs.Tab>
                <Tabs.Tab value="run" icon={<IconBrain size="0.8rem" />}>Run</Tabs.Tab>
              ...
              <Tabs.Panel value="run" pt="xs">
                ...
                <Text fz='sm'>
                  Run your pulse prompt on all prospects.
                </Text>
                <Card mt="md">
                  <Text fz='md'>
