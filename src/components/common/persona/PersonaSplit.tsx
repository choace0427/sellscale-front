  ...
  return (
    <Flex>
      <Container w="60%">
        ...
        <Text size="sm" mb="lg">
          Select the personas you want to split your contacts into and then
          click the button <Code>Split into Personas</Code> to automatically
          split your contacts into the selected personas.
        </Text>
        <PersonaSelect
          disabled={disablePersonaSplitButton}
          onChange={(archetypes) =>
            setDestinationPersonaIDs(archetypes.map((a) => a.archetype_id))
          }
          selectMultiple={true}
        ...
        <Flex align="center">
          ...
          >
            ...
            <Popover.Dropdown sx={{ pointerEvents: "none" }}>
              <Text size="sm">
                By splitting, the contacts in this persona will be divided into
                the selected personas automatically based on best fit.
              </Text>
              <Text size="sm">
              ...
              <List>
                ...
                <List.Item>
                  <Text size="sm">Role or responsibility</Text>
                </List.Item>
                <List.Item>
                  <Text size="sm">Company</Text>
                </List.Item>
                <List.Item>
                  <Text size="sm">Geographical location</Text>
                </List.Item>
                <List.Item>
