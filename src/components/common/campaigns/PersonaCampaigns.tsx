          ...
          <Group sx={{ flex: "35%" }} spacing={5} noWrap>
            ...
            <Box>
              <Badge
                size="xs"
                color={
                  props.persona.active && props.persona.total_sent > 0
                    ? "blue"
                    : !props.persona.active && props.persona.total_sent > 0
                    ? "green"
                    : "yellow"
          ...
          <Group sx={{ flex: "35%" }} spacing={5} noWrap>
            ...
            >
              ...
              <IconArrowDown
                ...
                style={{
                  transform:
                    sort === "desc" ? "rotate(0deg)" : "rotate(180deg)",
                }}
              />
            </Flex>
          </Group>
