      ...
      openConfirmModal({
        ...
        children: (
          <>
            ...
            <Text mt="md">
              <b>Pause Campaign:</b> Pausing this persona will prevent
              any new message generation, but Prospects still in the pipeline
              will continue to receive messages.
            </Text>
            <Text mt="xs">
              <b>Finish Campaign:</b> Finishing this campaign will wipe
              all messages from the pipeline and stop any and all contact with
              Prospects. This will also move all uncontacted prospects in this campaign to 
              the unassigned persona.
            </Text>
          </>
        ),
        labels: {
