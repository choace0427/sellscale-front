...
export default function SettingUsage() {
  ...
  const barchartData: any = {
    ...
    datasets: [
      {
        data: [770, 1100, 750, 1200, 1300, 700, 1450, 1000, 1100, 650, 1400, 800],
        fill: false,
    ...
    <Paper withBorder m='xs' p='md' radius='md'>
      <Box>
        <Grid>
          ...
          <Grid.Col span={3}>
            <Box py={20} px={20} style={{ border: '2px solid #f6f4f7', borderRadius: '6px', height: '100%' }}>
              <Flex direction={'column'} justify={'space-between'} align={'center'} gap={'sm'} h={'100%'}>
                <div className='w-[140px] m-[-30px] relative'>
                  ...
                  <Flex style={{ position: 'absolute', top: '65px', width: '100%', alignItems: 'center' }} direction={'column'}>
                    <Text fw={600}>78%</Text>{' '}
                    <Text size={12} fw={600}>
                      Limit Utilized
                    </Text>
                ...
                <Text size={12} fw={600} color='gray' align='center'>
                  You have used <span style={{ color: '#54a4f9' }}>548</span> out of <span style={{ fontWeight: '700', color: 'black' }}>2000</span> monthly
                  first touches.
                </Text>
